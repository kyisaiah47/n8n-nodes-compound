// ParseRail node description for n8n.
//
...
//
// Renamed from kynthNodeDescription on 2026-09-21: Kynth is retired across the
// estate. That generator lives in apps/parserail, not apps/kynth, and its own
// output was already lagging: this snapshot still said Kynth everywhere.

import type { INodeTypeDescription, NodeConnectionType } from 'n8n-workflow';

export const parseRailNodeDescription = {
	...({
	"displayName": "ParseRail",
	"name": "parseRail",
